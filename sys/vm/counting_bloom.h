 ...
 *
 * Optimal number of shorts is:
 *     shorts = (entries * ln(error)) / ln(2)^2
 *
...
/** ***************************************************************************
 * Add the frequency of element in counting bloom filter.
 ...
 *
 */
int bloom_add(struct bloom * bloom, const void * buffer, int len, int count);
